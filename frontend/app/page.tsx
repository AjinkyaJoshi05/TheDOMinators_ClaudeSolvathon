    ...
    <main className="min-h-dvh">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 space-y-10">
        <div className="space-y-4">
          <h1 className="text-balance text-3xl md:text-5xl">Event Horizon Interface</h1>
          <p className="text-muted-foreground max-w-2xl leading-relaxed">
            A cosmic, high-tech UI system built with semantic tokens, subtle energy animations, and accessible dark-mode
            design.
          </p>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <EHCard>
            <h3 className="mb-2 text-lg">Quantum Panel</h3>
            <p className="text-muted-foreground">Floating surfaces with glowing borders and smooth transitions.</p>
          </EHCard>
          <EHCard>
            <h3 className="mb-2 text-lg">Plasma Controls</h3>
            <p className="text-muted-foreground">Buttons surge with energy on hover and press.</p>
          </EHCard>
          <EHCard>
            <h3 className="mb-2 text-lg">Adaptive Darkness</h3>
            <p className="text-muted-foreground">Built for consistent, accessible dark interfaces.</p>
          </EHCard>
        </div>
        ...
        <EHPanel className="p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Manage systems with clarity and focus.</p>
            </div>
